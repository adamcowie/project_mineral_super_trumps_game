...
public class SuperTrumpsCard {
    ...
    public SuperTrumpsCard(String cardName, String cardType, String cardChem, String cardClass, String cardCrystal, String cardOccurrence, double cardHardness, double cardGravity, int cardCleavage, int cardAbundance, int cardValue)
    {
